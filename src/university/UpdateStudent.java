...
class UpdateStudent implements ActionListener{
    ...
    UpdateStudent(){
        ...
        // Title
        id8 = new JLabel("Update Student Details", JLabel.CENTER);
        id8.setBounds(0, 20, 900, 40);
        id8.setFont(new Font("Arial", Font.BOLD, 28));
        id8.setForeground(new Color(25, 25, 112));
        f.add(id8);
        ...
        // Row 6
        createField(formPanel, "Roll No:", 20, 240, t11 = new JTextField());
        createField(formPanel, "Course:", 420, 240, t13 = new JTextField());

        // Row 7
        createField(formPanel, "Branch:", 20, 280, t14 = new JTextField());

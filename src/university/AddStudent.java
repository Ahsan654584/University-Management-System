...
class AddStudent implements ActionListener {
    ...
    JFrame f;
    JLabel id, id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id12, id15, lab, lab2;
    ...
    public AddStudent() {
        ...
        String course[] = {"B.Tech", "BBA", "BE", "Bsc", "Msc", "MBA", "MCA", "BA", "BCom"};
        c1 = new JComboBox<String>(course);
        ...
        String branch[] = {"Computer Engineering", "Electronics", "Electrical", "Mechanical", "Civil"};
        c2 = new JComboBox<String>(branch);
